CREATE TABLE f_bde_Mir_groups_pool AS
...
Select * from f_bde_Mir_groups_pool where rownum=1;
Select count(*) from f_bde_Mir_groups_pool;

CREATE TABLE f_bde_Mir_groups_set PARALLEL COMPRESS AS
(SELECT p.photo_id,
...
Select * from f_bde_Mir_groups_set where rownum=1;
Select count(*) from f_bde_Mir_groups_set;